...
for folder in directories:
    ...
    sizeInSubFolders = 0
    #print(folder.path + ' Size: ' + str(sizeInCurrentFolder))
    ...
    for subFolder in directories:
        if((folder.path == '/' and subFolder.path != '/') or (subFolder.path.startswith(folder.path+'/') and subFolder.path != '/')):
            #print(subFolder.path + ' Size: ' + str(subFolder.getTotalFileSize()))
    ...
    if(totalSizeInFolder < 100000):
        sum += totalSizeInFolder
